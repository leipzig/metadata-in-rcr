...
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------|:------------------|:--------|:---------|:------------------------------------------------------------------------------|
|CellML&nbsp;[:books:](https://doi.org/10.1177/0037549703040939)&nbsp;[:house:](https://www.cellml.org/)&nbsp;[:clipboard:](data/examples/cellml_saucerman_brunton_michailova_mcculloch_2003.xml) |Input       |Biology            |XML      |RDF       |                                                                               | CellML is an XML based markup language for describing mathematical models for biology
...
|DATS&nbsp;[:books:](https://doi.org/10.1093/gigascience/giz165)&nbsp;[:house:](https://github.com/datatagsuite)&nbsp;                                                                            |Input       |Biomedical         |JSON     |          |                                                                               | metadata (people, org, repo) for data pubs 
